...
export class MapComponent implements AfterViewInit {
  @ViewChild('bottomComponent', { read: ViewContainerRef })
  bottomComponent!: ViewContainerRef;
  @ViewChild('leftComponent', { read: ViewContainerRef })
  leftComponent!: ViewContainerRef;
  @ViewChild('secondTopComponent', { read: ViewContainerRef })
  secondTopComponent!: ViewContainerRef;
  @ViewChild('topComponent', { read: ViewContainerRef })
  topComponent!: ViewContainerRef;
  @ViewChild('topOfBottomComponent', { read: ViewContainerRef })
  topOfBottomComponent!: ViewContainerRef;
  ...
  ngAfterViewInit() {
    setTimeout(() => {
      var factory1 = this.componentFactoryResolver.resolveComponentFactory(
        BottomComponentComponent
      );
      this.bottomComponent.createComponent(factory1);

      var factory2 = this.componentFactoryResolver.resolveComponentFactory(
        LeftComponentComponent
      );
      this.leftComponent.createComponent(factory2);

      var factory3 = this.componentFactoryResolver.resolveComponentFactory(
        SecondTopComponentComponent
      );
      this.secondTopComponent.createComponent(factory3);

      var factory4 = this.componentFactoryResolver.resolveComponentFactory(
        TopComponentComponent
      );
      this.topComponent.createComponent(factory4);

      var factory5 = this.componentFactoryResolver.resolveComponentFactory(
